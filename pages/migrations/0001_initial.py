        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "card_titles",
                    models.TextField(
                        blank=True, help_text="use | for next line", null=True
                    ),
                ),
                (
                    "card_descriptions",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "card_descriptions",
                    models.TextField(
                        help_text="use | for next line . must same line as card-title"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="pages.eligibility",
                    ),
                ),
                ("extra_cards", models.ManyToManyField(blank=True, to="pages.cards")),
                (
                    "extra_split_faces",
                    models.ManyToManyField(blank=True, to="pages.splitface"),
                ),
                (
                    "faq",
                    models.ForeignKey(
